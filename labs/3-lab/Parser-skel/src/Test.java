...
//		System.out.println(tree.toStringTree(parser));
        ...
        var listener = new CPLangParserBaseListener() {
			...
			@Override
			public void exitVariable_def(CPLangParser.Variable_defContext ctx) {
				varDefs++;
			}

			@Override
			public void exitFunction_def(CPLangParser.Function_defContext ctx) {
				funcDefs++;
			}
    ...
    public static void task3() throws IOException {
		...
		var visitor = new CPLangParserBaseVisitor<Integer>() {
			...
			@Override
			public Integer visitMinus_expr(CPLangParser.Minus_exprContext ctx) {
				return visit(ctx.expr(0)) - visit(ctx.expr(1));
			}
			...
			@Override
			public Integer visitExpr_par(CPLangParser.Expr_parContext ctx) {
